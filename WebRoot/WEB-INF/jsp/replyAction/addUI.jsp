	...
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<s:a action="forum_show?id=%{#topic.forum.id}">${topic.title }</s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				帖子回复
			</div>
		</div>
		<div class="ItemBlockBorder">
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				<tr>
					...
					<td class="InputAreaBg"><div class="InputContent">${topic.content }</div></td>
				</tr>
				<tr>
					<td class="InputAreaBg" height="30"><div class="InputTitle">标题</div></td>
					<td class="InputAreaBg"><div class="InputContent">
						<s:textfield type="text" name="title" class="InputStyle" style="width:100%" value="回复：%{#topic.title}"/></div>
					</td>
				</tr>
				<tr>
					
					<td class="InputAreaBg"><div class="InputContent"></div>
					</td>
				</tr>
				<tr height="240">
